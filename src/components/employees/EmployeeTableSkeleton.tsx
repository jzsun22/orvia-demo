        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-oatbeige/60">
            <tr>
              ...
              >
                <Skeleton className="h-4 w-20 animate-pulse duration-1200" />
              </th>
              <th
                scope="col"
            ...
            {Array.from({ length: 16 }).map((_, i) => (
              <tr key={i}>
                <td className="py-6 pl-8 pr-4">
                  <Skeleton className="h-5 w-24 xl:w-40 animate-pulse duration-1200" />
                </td>
                <td className="py-6 pr-4 hidden lg:table-cell xl:hidden">
                  <Skeleton className="h-5 xl:w-64 animate-pulse duration-1200" />
                </td>
                <td className="py-6 px-2 hidden xl:table-cell">
                  <Skeleton className="h-5 w-48 animate-pulse duration-1200" />
                </td>
                <td className="py-6 px-2 hidden xl:table-cell">
                  <Skeleton className="h-5 w-32 animate-pulse duration-1200" />
                </td>
                <td className="py-6 pr-6">
                  <div className="flex gap-2">
                    <Skeleton className="h-8 w-20 rounded-md animate-pulse duration-1200" />
                    <Skeleton className="h-8 w-32 rounded-md animate-pulse duration-1200" />
                  </div>
                </td>
              </tr>
            ))}
