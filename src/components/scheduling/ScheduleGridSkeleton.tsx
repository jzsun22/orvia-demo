    ...
    <div className="mb-12">
      <ScrollArea className="border rounded-lg bg-white shadow-md">
        <div className="p-3 border-b border-gray-300 bg-oatbeige">
          <Skeleton className="h-7 w-32 rounded-md animate-pulse duration-1200" />
        </div>
          ...
          <thead>
            <tr className="bg-[#F9F6F4]">
              <th className="text-left pl-3 pr-4 py-2 font-semibold border-b border-r whitespace-nowrap align-top w-[100px] 2xl:w-[120px] bg-[#F9F6F4]">
                <Skeleton className="h-5 w-10 rounded-md animate-pulse duration-1200" />
              </th>
              {columns.map((_, i) => (
                <th
                  key={i}
                ...
                >
                  <div className="flex flex-col items-center gap-1.5">
                    <Skeleton className="h-5 w-24 rounded-md animate-pulse duration-1200" />
                    <Skeleton className="h-4 w-28 rounded-md animate-pulse duration-1200" />
                  </div>
                </th>
              ))}
            </tr>
              ...
              <tr key={i} className="border-t odd:bg-almondmilk/30 even:bg-white">
                <td className="pl-3 pr-4 py-2.5 border-r font-medium whitespace-nowrap align-top w-[100px] 2xl:w-[120px] bg-card">
                  <div className="flex flex-col gap-1.5">
                    <Skeleton className="h-5 w-16 rounded-md animate-pulse duration-1200" />
                    <Skeleton className="h-4 w-10 rounded-md animate-pulse duration-1200" />
                  </div>
                </td>
                {columns.map((_, j) => (
                  <td key={j} className="px-2 py-2.5 border-r last:border-r-0 text-center h-[52px] align-middle">
                    <Skeleton className="h-8 w-24 rounded-md mx-auto animate-pulse duration-1200" />
                  </td>
                ))}
              </tr>
            ))}
