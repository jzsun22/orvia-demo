...
function CalendarHeader() {
  return (
    <header className="flex w-full items-center gap-1 pb-1">
      <Button
        slot="previous"
        className="text-muted-foreground/80 hover:bg-accent/50 hover:text-foreground focus-visible:ring-ring/50 flex size-9 items-center justify-center rounded-md transition-[color,box-shadow] outline-none focus-visible:ring-[3px]"
      >
      ...
      <CalendarGridBodyRac className="[&_td]:px-0 [&_td]:py-px">
        {(date) => (
          <CalendarCellRac
            date={date}
            className={cn(
              "text-foreground data-[hovered]:bg-lavendercream/50 data-selected:bg-primary data-[hovered]:text-muted-foreground data-selected:text-primary-foreground data-[focused]:bg-accent/50 relative flex size-9 items-center justify-center rounded-md p-0 text-sm font-normal whitespace-nowrap [transition-property:color,background-color,border-radius,box-shadow] duration-150 outline-none data-[disabled]:pointer-events-none data-outside-month:text-muted-foreground data-[disabled]:opacity-30 data-[focused]:z-10 data-[unavailable]:pointer-events-none data-outside-month:pointer-events-none data-[unavailable]:line-through data-[unavailable]:opacity-30",
