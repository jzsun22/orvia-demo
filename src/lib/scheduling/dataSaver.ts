...
export async function saveSchedule(
   ...
   // const cutoffDateString = formatDateToYYYYMMDD(cutoffDate);
    ...
    try {
        ...
        /*
        // 1. Delete shifts older than ~4 weeks (Assignments should cascade) -- handled by Supabase Cron job
        ...
        */
        ...
        // 1. Delete shifts for the target week (Assignments should cascade)
        // Only attempt delete if there are template IDs to filter by
        if (templateIdsForLocation.length > 0) {
