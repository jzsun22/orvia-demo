...
// --- Constants for Paired Prep+Barista Shifts (Cedar Loop) ---
export const CEDAR_LOOP_LOCATION_ID = Deno.env.get("CEDAR_LOOP_LOCATION_ID");
...
export async function getPairedShiftPartnerDetails(
  ...
  if (currentTemplateData.position_id !== PREP_BARISTA_POSITION_ID || currentTemplateData.location_id !== CEDAR_LOOP_LOCATION_ID) {
  ...
  if (partnerTemplate.position_id !== PREP_BARISTA_POSITION_ID || partnerTemplate.location_id !== CEDAR_LOOP_LOCATION_ID) {
